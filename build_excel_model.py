...
# Setup paths — resolve dynamically from script location
base_dir = os.path.dirname(os.path.abspath(__file__))
data_dir = os.path.join(base_dir, "02_Data")
output_dir = os.path.join(base_dir, "04_Excel_Model")
...
ws_inst.write('B8', '2. Run build_excel_model.py (regenerates this workbook from live SQL data + validation CSVs).')
